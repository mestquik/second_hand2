        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{route('category.create')}}" class="btn btn-primary"> Yeni Kategori Oluştur</a>
                                ...
                                <table class="display expandable-table" style="width:100%">
                                    ...
                                    @if(!empty($categories) && $categories->count()>0)
                                        ...
                                        @foreach($categories as $category)
                                            ...
                                            <tr>
                                                <td  class="py-1">
                                                    <img id="image" style="width:50px; height:50px" src="{{asset('img/categories/').'/'.$category->image ?? '' }}"
                                            ...
                                            '{{asset('/img/categories/').'/'.$category->image}}')"
